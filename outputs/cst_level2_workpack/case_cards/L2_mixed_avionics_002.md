...
| Item | Value |
|---|---|
| CST project | `CST_L2_mixed_avionics_002.cst` |
| Carrier model | `level2_multisource_no_airframe` |
| Working state | `mixed_avionics_state` |
| Source config | `mixed_avionics` |
| Frequency count | 5 |
| Near-field export | `data/cst_exports/level2/L2_mixed_avionics_002_nearfield.csv` |
| Far-field export | `data/cst_exports/level2/L2_mixed_avionics_002_farfield.csv` |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | `belly_nav` | `ideal_dipole_or_small_discrete_port` | -2.75 | 1.5 | 1.0 | 1.0 | 0.0 | 0.0 | 0.7866016277176194 | 14.48407618858375 |
| 1 | `top_link` | `ideal_dipole_or_small_discrete_port` | 2.75 | -1.5 | 7.0 | 0.0 | 1.0 | 0.0 | 1.1476483010293883 | 90.76055702195713 |
| 2 | `side_beacon` | `ideal_dipole_or_small_discrete_port` | 0.0 | 4.5 | 4.0 | 0.0 | 0.0 | 1.0 | 0.5766253033283631 | -45.43065688464456 |
