...
| Item | Value |
|---|---|
| CST project | `CST_L2_mixed_avionics_006.cst` |
| Carrier model | `level2_multisource_no_airframe` |
| Working state | `mixed_avionics_state` |
| Source config | `mixed_avionics` |
| Frequency count | 5 |
| Near-field export | `data/cst_exports/level2/L2_mixed_avionics_006_nearfield.csv` |
| Far-field export | `data/cst_exports/level2/L2_mixed_avionics_006_farfield.csv` |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | `belly_nav` | `ideal_dipole_or_small_discrete_port` | -2.75 | 1.5 | 1.0 | 1.0 | 0.0 | 0.0 | 0.8303540654165883 | 14.5206793603077 |
| 1 | `top_link` | `ideal_dipole_or_small_discrete_port` | 2.75 | -1.5 | 7.0 | 0.0 | 1.0 | 0.0 | 1.0654096977899403 | 68.71388015155772 |
| 2 | `side_beacon` | `ideal_dipole_or_small_discrete_port` | 0.0 | 4.5 | 4.0 | 0.0 | 0.0 | 1.0 | 0.7801419136436188 | -31.83630927676382 |
