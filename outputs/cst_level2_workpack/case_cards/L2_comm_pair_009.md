...
| Item | Value |
|---|---|
| CST project | `CST_L2_comm_pair_009.cst` |
| Carrier model | `level2_multisource_no_airframe` |
| Working state | `comm_pair_state` |
| Source config | `comm_pair` |
| Frequency count | 5 |
| Near-field export | `data/cst_exports/level2/L2_comm_pair_009_nearfield.csv` |
| Far-field export | `data/cst_exports/level2/L2_comm_pair_009_farfield.csv` |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | `left_comm` | `ideal_dipole_or_small_discrete_port` | -5.5 | -4.5 | 4.0 | 1.0 | 0.0 | 0.0 | 0.979513163598699 | 2.265661409215348 |
| 1 | `right_comm` | `ideal_dipole_or_small_discrete_port` | 5.5 | 4.5 | 4.0 | 0.0 | 1.0 | 0.0 | 0.7774584929387218 | 32.396008220085406 |
