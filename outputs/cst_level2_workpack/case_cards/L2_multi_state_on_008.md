...
| Item | Value |
|---|---|
| CST project | `CST_L2_multi_state_on_008.cst` |
| Carrier model | `level2_multisource_no_airframe` |
| Working state | `multi_state_on_state` |
| Source config | `multi_state_on` |
| Frequency count | 5 |
| Near-field export | `data/cst_exports/level2/L2_multi_state_on_008_nearfield.csv` |
| Far-field export | `data/cst_exports/level2/L2_multi_state_on_008_farfield.csv` |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | `left_top_emitter` | `ideal_dipole_or_small_discrete_port` | -5.5 | 4.5 | 7.0 | 1.0 | 0.0 | 0.0 | 0.961969624167114 | 98.42270708008664 |
| 1 | `right_belly_emitter` | `ideal_dipole_or_small_discrete_port` | 5.5 | -4.5 | 1.0 | 0.0 | 1.0 | 0.0 | 0.7744718839608578 | -62.99500725997317 |
| 2 | `center_avionics` | `ideal_dipole_or_small_discrete_port` | 0.0 | 0.0 | 4.0 | 0.0 | 0.0 | 1.0 | 0.9254606321944276 | 19.97279938787732 |
