# L2_mixed_avionics_005

Class label: `mixed_avionics`  
Variant index: `5`  
...
| Item | Value |
|---|---|
| CST project | `CST_L2_mixed_avionics_005.cst` |
| Carrier model | `level2_multisource_no_airframe` |
| Working state | `mixed_avionics_state` |
| Source config | `mixed_avionics` |
| Frequency count | 5 |
| Near-field export | `data/cst_exports/level2/L2_mixed_avionics_005_nearfield.csv` |
| Far-field export | `data/cst_exports/level2/L2_mixed_avionics_005_farfield.csv` |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | `belly_nav` | `ideal_dipole_or_small_discrete_port` | -2.75 | 1.5 | 1.0 | 1.0 | 0.0 | 0.0 | 0.816018604503707 | 20.824727254596567 |
| 1 | `top_link` | `ideal_dipole_or_small_discrete_port` | 2.75 | -1.5 | 7.0 | 0.0 | 1.0 | 0.0 | 1.1044337844654843 | 53.251550959357765 |
| 2 | `side_beacon` | `ideal_dipole_or_small_discrete_port` | 0.0 | 4.5 | 4.0 | 0.0 | 0.0 | 1.0 | 0.7448251534797601 | -8.001568212239384 |
