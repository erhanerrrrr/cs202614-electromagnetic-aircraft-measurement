...
| Item | Value |
|---|---|
| CST project | `CST_L2_mixed_avionics_003.cst` |
| Carrier model | `level2_multisource_no_airframe` |
| Working state | `mixed_avionics_state` |
| Source config | `mixed_avionics` |
| Frequency count | 5 |
| Near-field export | `data/cst_exports/level2/L2_mixed_avionics_003_nearfield.csv` |
| Far-field export | `data/cst_exports/level2/L2_mixed_avionics_003_farfield.csv` |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | `belly_nav` | `ideal_dipole_or_small_discrete_port` | -2.75 | 1.5 | 1.0 | 1.0 | 0.0 | 0.0 | 0.8170491666729258 | -2.7224405564098824 |
| 1 | `top_link` | `ideal_dipole_or_small_discrete_port` | 2.75 | -1.5 | 7.0 | 0.0 | 1.0 | 0.0 | 0.9671068169426242 | 85.3623677571826 |
| 2 | `side_beacon` | `ideal_dipole_or_small_discrete_port` | 0.0 | 4.5 | 4.0 | 0.0 | 0.0 | 1.0 | 0.7114725412130344 | -25.01435525272798 |
