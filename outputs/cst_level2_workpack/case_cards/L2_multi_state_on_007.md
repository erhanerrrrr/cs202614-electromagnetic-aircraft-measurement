...
| Item | Value |
|---|---|
| CST project | `CST_L2_multi_state_on_007.cst` |
| Carrier model | `level2_multisource_no_airframe` |
| Working state | `multi_state_on_state` |
| Source config | `multi_state_on` |
| Frequency count | 5 |
| Near-field export | `data/cst_exports/level2/L2_multi_state_on_007_nearfield.csv` |
| Far-field export | `data/cst_exports/level2/L2_multi_state_on_007_farfield.csv` |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | `left_top_emitter` | `ideal_dipole_or_small_discrete_port` | -5.5 | 4.5 | 7.0 | 1.0 | 0.0 | 0.0 | 1.0501503921478517 | 108.5572177047802 |
| 1 | `right_belly_emitter` | `ideal_dipole_or_small_discrete_port` | 5.5 | -4.5 | 1.0 | 0.0 | 1.0 | 0.0 | 0.8730764024548573 | -63.86030110315201 |
| 2 | `center_avionics` | `ideal_dipole_or_small_discrete_port` | 0.0 | 0.0 | 4.0 | 0.0 | 0.0 | 1.0 | 1.0471396330308036 | 7.757514680199256 |
