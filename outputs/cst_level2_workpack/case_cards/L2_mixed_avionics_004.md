...
| Item | Value |
|---|---|
| CST project | `CST_L2_mixed_avionics_004.cst` |
| Carrier model | `level2_multisource_no_airframe` |
| Working state | `mixed_avionics_state` |
| Source config | `mixed_avionics` |
| Frequency count | 5 |
| Near-field export | `data/cst_exports/level2/L2_mixed_avionics_004_nearfield.csv` |
| Far-field export | `data/cst_exports/level2/L2_mixed_avionics_004_farfield.csv` |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | `belly_nav` | `ideal_dipole_or_small_discrete_port` | -2.75 | 1.5 | 1.0 | 1.0 | 0.0 | 0.0 | 0.8832062305123447 | 6.605544761327447 |
| 1 | `top_link` | `ideal_dipole_or_small_discrete_port` | 2.75 | -1.5 | 7.0 | 0.0 | 1.0 | 0.0 | 0.8801587215053336 | 71.99875848867636 |
| 2 | `side_beacon` | `ideal_dipole_or_small_discrete_port` | 0.0 | 4.5 | 4.0 | 0.0 | 0.0 | 1.0 | 0.7217097713299726 | -22.224442308602864 |
