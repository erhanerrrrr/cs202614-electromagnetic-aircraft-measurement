...
| Item | Value |
|---|---|
| CST project | `CST_L2_radar_top_011.cst` |
| Carrier model | `level2_multisource_no_airframe` |
| Working state | `radar_top_state` |
| Source config | `radar_top` |
| Frequency count | 5 |
| Near-field export | `data/cst_exports/level2/L2_radar_top_011_nearfield.csv` |
| Far-field export | `data/cst_exports/level2/L2_radar_top_011_farfield.csv` |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | `front_top_radar` | `ideal_dipole_or_small_discrete_port` | 0.0 | -4.5 | 7.0 | 0.0 | 0.0 | 1.0 | 1.1605806980766336 | 6.924439062562126 |
| 1 | `rear_top_radar` | `ideal_dipole_or_small_discrete_port` | 0.0 | 4.5 | 7.0 | 0.0 | 0.0 | 1.0 | 0.954399279673613 | -45.58661099361716 |
