...
| Item | Value |
|---|---|
| CST project | `CST_L2_multi_state_on_000.cst` |
| Carrier model | `level2_multisource_no_airframe` |
| Working state | `multi_state_on_state` |
| Source config | `multi_state_on` |
| Frequency count | 5 |
| Near-field export | `data/cst_exports/level2/L2_multi_state_on_000_nearfield.csv` |
| Far-field export | `data/cst_exports/level2/L2_multi_state_on_000_farfield.csv` |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | `left_top_emitter` | `ideal_dipole_or_small_discrete_port` | -5.5 | 4.5 | 7.0 | 1.0 | 0.0 | 0.0 | 1.1062690748631248 | 94.4086947280931 |
| 1 | `right_belly_emitter` | `ideal_dipole_or_small_discrete_port` | 5.5 | -4.5 | 1.0 | 0.0 | 1.0 | 0.0 | 0.7696782161867123 | -50.74256025258885 |
| 2 | `center_avionics` | `ideal_dipole_or_small_discrete_port` | 0.0 | 0.0 | 4.0 | 0.0 | 0.0 | 1.0 | 0.9523628535490168 | 13.374462614734288 |
