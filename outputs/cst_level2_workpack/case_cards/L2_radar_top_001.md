...
| Item | Value |
|---|---|
| CST project | `CST_L2_radar_top_001.cst` |
| Carrier model | `level2_multisource_no_airframe` |
| Working state | `radar_top_state` |
| Source config | `radar_top` |
| Frequency count | 5 |
| Near-field export | `data/cst_exports/level2/L2_radar_top_001_nearfield.csv` |
| Far-field export | `data/cst_exports/level2/L2_radar_top_001_farfield.csv` |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | `front_top_radar` | `ideal_dipole_or_small_discrete_port` | 0.0 | -4.5 | 7.0 | 0.0 | 0.0 | 1.0 | 1.2086453828403882 | 9.046092156496844 |
| 1 | `rear_top_radar` | `ideal_dipole_or_small_discrete_port` | 0.0 | 4.5 | 7.0 | 0.0 | 0.0 | 1.0 | 0.8170823208364696 | -34.267289882293085 |
