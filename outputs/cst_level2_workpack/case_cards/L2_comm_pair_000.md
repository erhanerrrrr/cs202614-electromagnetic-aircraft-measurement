...
| Item | Value |
|---|---|
| CST project | `CST_L2_comm_pair_000.cst` |
| Carrier model | `level2_multisource_no_airframe` |
| Working state | `comm_pair_state` |
| Source config | `comm_pair` |
| Frequency count | 5 |
| Near-field export | `data/cst_exports/level2/L2_comm_pair_000_nearfield.csv` |
| Far-field export | `data/cst_exports/level2/L2_comm_pair_000_farfield.csv` |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | `left_comm` | `ideal_dipole_or_small_discrete_port` | -5.5 | -4.5 | 4.0 | 1.0 | 0.0 | 0.0 | 1.0184623012989735 | 15.515600639653698 |
| 1 | `right_comm` | `ideal_dipole_or_small_discrete_port` | 5.5 | 4.5 | 4.0 | 0.0 | 1.0 | 0.0 | 0.8990764178437912 | 32.427835552351745 |
