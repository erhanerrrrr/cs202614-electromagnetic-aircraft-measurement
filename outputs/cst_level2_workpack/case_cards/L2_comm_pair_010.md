...
| Item | Value |
|---|---|
| CST project | `CST_L2_comm_pair_010.cst` |
| Carrier model | `level2_multisource_no_airframe` |
| Working state | `comm_pair_state` |
| Source config | `comm_pair` |
| Frequency count | 5 |
| Near-field export | `data/cst_exports/level2/L2_comm_pair_010_nearfield.csv` |
| Far-field export | `data/cst_exports/level2/L2_comm_pair_010_farfield.csv` |
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | `left_comm` | `ideal_dipole_or_small_discrete_port` | -5.5 | -4.5 | 4.0 | 1.0 | 0.0 | 0.0 | 0.973541722717992 | -14.693574180983251 |
| 1 | `right_comm` | `ideal_dipole_or_small_discrete_port` | 5.5 | 4.5 | 4.0 | 0.0 | 1.0 | 0.0 | 0.9558463077120608 | 38.73143229720468 |
