...
| Start x/y/z m | `0.0`, `0.0`, `3.9375432379166666` |
| End x/y/z m | `0.0`, `0.0`, `4.062456762083333` |

## Export Targets

| Export | Path | Expected rows |
|---|---|---:|
| Near-field real/imag | `data/cst_exports/level1/L1_halfwave_dipole_z_1p2G_nearfield.csv` | 486 |
| Far-field real/imag | `data/cst_exports/level1/L1_halfwave_dipole_z_1p2G_farfield.csv` | 2664 |
| Near-field magnitude/phase fallback | `data/cst_exports/level1/L1_halfwave_dipole_z_1p2G_nearfield_phase.csv` | 486 |
| Far-field magnitude/phase fallback | `data/cst_exports/level1/L1_halfwave_dipole_z_1p2G_farfield_phase.csv` | 2664 |
