...
| trusted_sanity | meshsafe_huygens_real_cst_batch | impedance_region_proxy_batch_pass | real_cst_data_chain_not_final_huygens_proof | L1_short_dipole_z_1p2G:region_shape_pass/outgoing_equivalence_minus_eta0p25/eta=0.250eta0; L1_halfwave_dipole_z_1p2G:region_shape_pass/outgoing_equivalence_minus_eta0p25/eta=0.250eta0 | 0.9989 | 8.4827e-04 | 0.00 | 96 | `data\sampling_layouts\cst_meshsafe_huygens_extrapolation_batch\meshsafe_huygens_batch_summary.json` |
...
- `meshsafe_huygens_real_cst_batch`: The mesh-safe route now uses real CST local probe curves for two Level 1 sources and passes the data-chain/region-lobe gate with scalar impedance calibration (2/2 best settings use non-eta0 eta_eff); it still needs independent H-field support before being used as final Stratton-Chu/Huygens proof.
