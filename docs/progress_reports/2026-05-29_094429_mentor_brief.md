...
汇报时间：2026-05-29 09:44:29 +0800  
汇报对象：导师/组会快速阅读版  
阶段标记：`M-20260529-094429`
...
| 提交草稿 | 当前 submission 草稿包 68 项已复制或生成，缺失源文件为 0 | `submission/`; `submission/submission_draft_summary.json` |

## 本次变化摘要

| 类型 | 变化/备注 |
| --- | --- |
| artifact_change | 关键文件更新：src/build_progress_report.py: 内容已更新 |
| artifact_change | 关键文件更新：src/build_submission_draft.py: 内容已更新 |
| artifact_change | 关键文件更新：src/build_presentation_package.py: 内容已更新 |
| artifact_change | 关键文件更新：outputs/report_package/report_package_summary.json: 内容已更新 |
| artifact_change | 关键文件更新：outputs/presentation_package/presentation_package_summary.json: 内容已更新 |
| artifact_change | 关键文件更新：submission/submission_draft_summary.json: 内容已更新 |

## 完成度图表

### 图片版总览

![Gate 和提交物状态](assets/M-20260529-094429_status_overview.png)

![最终交付物状态](assets/M-20260529-094429_final_deliverables.png)

![阶段趋势](assets/M-20260529-094429_progress_history.png)
...
| 正式交付物已存在 1/4，尚缺 正式报告 PDF、答辩 PPTX、演示视频 MP4。 | 不能进入最终提交态 | 在指标稳定后集中成稿并导出剩余正式文件 |
