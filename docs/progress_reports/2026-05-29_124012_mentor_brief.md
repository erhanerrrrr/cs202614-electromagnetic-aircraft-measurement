...
| 提交草稿 | 当前 submission 草稿包 75 项已复制或生成，缺失源文件为 0 | `submission/`; `submission/submission_draft_summary.json` |
...
flowchart LR
  ...
  G4 --> G5
  G6["G5 最终报告 PDF/DOCX、答辩 PPT...: complete"]
  G5 --> G6
...
| 正式交付物已存在 5/5，四件套已齐全。 | 不能进入最终提交态 | 在指标稳定后集中成稿并导出剩余正式文件 |
