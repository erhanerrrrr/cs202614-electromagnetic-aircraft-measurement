...
| Item | Path |
|---|---|
| Local Huygens E field | `data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\fibonacci_snap_32_poly_full96_efield.csv` |
| Local Huygens H field | `data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\fibonacci_snap_32_poly_full96_hfield.csv` |
...
| Normal/total L2 ratio | `0.1642` |
| Dynamic range / dB | `10.87` |
| H tangential/total L2 ratio | `0.9996` |
| H normal/total L2 ratio | `0.0299` |
| H dynamic range / dB | `16.57` |
| Tangential E/H impedance / ohm | `372.807` |
| Tangential E/H eta0 ratio | `0.9896` |
...
| Correlation | `0.9966` |
| Normalized NMSE | `1.3561e-03` |
| Scale-fitted power NMSE | `8.2770e-04` |
| Main-lobe error / deg | `94.78` |
| Region-lobe error / deg | `0.00` |
| Region-lobe Jaccard | `0.948` |
...
|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| outgoing_equivalence_plus | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9966 | 1.3561e-03 | 8.2770e-04 | 94.78 | 0.00 | 0.948 | 3.0569e-02 |
| eh_love_equivalence_plus | real_eh_surface_currents | True | 1 | 1.0 | region_shape_pass | 0.9966 | 1.3613e-03 | 8.2900e-04 | 94.78 | 0.00 | 0.948 | 3.0569e-02 |
| magnetic_only_plus | not_used | False | 1 |  | region_shape_pass | 0.9966 | 1.3598e-03 | 8.2904e-04 | 94.78 | 0.00 | 0.948 | 3.0569e-02 |
| magnetic_only_minus | not_used | False | 1 |  | region_shape_pass | 0.9966 | 1.3598e-03 | 8.2904e-04 | 94.78 | 0.00 | 0.948 | 3.0569e-02 |
| eh_love_equivalence_minus | real_eh_surface_currents | True | 1 | 1.0 | region_shape_pass | 0.9966 | 1.3583e-03 | 8.2916e-04 | 94.78 | 0.00 | 0.948 | 3.0568e-02 |
| outgoing_equivalence_minus | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9966 | 1.3636e-03 | 8.3048e-04 | 94.78 | 0.00 | 0.948 | 3.0568e-02 |
| eh_love_equivalence_plus_j96 | real_eh_j_scale_scan | True | 1 | 96.0 | region_shape_pass | 0.9951 | 7.9999e-03 | 1.2164e-03 | 159.28 | 0.00 | 0.867 | 3.0009e-02 |
| eh_love_equivalence_minus_j96 | real_eh_j_scale_scan | True | 1 | 96.0 | region_shape_pass | 0.9950 | 5.0487e-03 | 1.2191e-03 | 22.04 | 0.00 | 0.906 | 2.9940e-02 |
| electric_only_outgoing | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9759 | 2.9270e-02 | 6.0099e-03 | 33.77 | 0.00 | 0.724 | 1.4060e+04 |
| hfield_electric_only | real_hfield_only | True | 1 | 1.0 | shape_pass_lobe_ambiguous | 0.9715 | 3.0798e-02 | 6.9994e-03 | 31.41 | 0.00 | 0.717 | 1.4403e+04 |
