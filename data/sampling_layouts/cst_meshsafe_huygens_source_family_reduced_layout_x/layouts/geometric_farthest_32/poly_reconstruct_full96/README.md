...
| Item | Path |
|---|---|
| Local Huygens E field | `data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\geometric_farthest_32_poly_full96_efield.csv` |
| Local Huygens H field | `data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\geometric_farthest_32_poly_full96_hfield.csv` |
...
| Tangential/total L2 ratio | `0.9869` |
| Normal/total L2 ratio | `0.1611` |
| Dynamic range / dB | `11.46` |
| H tangential/total L2 ratio | `0.9996` |
| H normal/total L2 ratio | `0.0272` |
| H dynamic range / dB | `18.70` |
| Tangential E/H impedance / ohm | `370.608` |
| Tangential E/H eta0 ratio | `0.9837` |
...
| Correlation | `0.9955` |
| Normalized NMSE | `1.7067e-03` |
| Scale-fitted power NMSE | `1.0861e-03` |
| Main-lobe error / deg | `94.75` |
| Region-lobe error / deg | `0.00` |
| Region-lobe Jaccard | `0.949` |
| Region-lobe min capture | `0.961` |
...
|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| outgoing_equivalence_plus | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9955 | 1.7067e-03 | 1.0861e-03 | 94.75 | 0.00 | 0.949 | 3.0620e-02 |
| eh_love_equivalence_minus | real_eh_surface_currents | True | 1 | 1.0 | region_shape_pass | 0.9955 | 1.7037e-03 | 1.0867e-03 | 94.75 | 0.00 | 0.949 | 3.0618e-02 |
| magnetic_only_plus | not_used | False | 1 |  | region_shape_pass | 0.9955 | 1.7085e-03 | 1.0876e-03 | 94.75 | 0.00 | 0.949 | 3.0619e-02 |
| magnetic_only_minus | not_used | False | 1 |  | region_shape_pass | 0.9955 | 1.7085e-03 | 1.0876e-03 | 94.75 | 0.00 | 0.949 | 3.0619e-02 |
| eh_love_equivalence_plus | real_eh_surface_currents | True | 1 | 1.0 | region_shape_pass | 0.9955 | 1.7133e-03 | 1.0887e-03 | 94.75 | 0.00 | 0.949 | 3.0620e-02 |
| outgoing_equivalence_minus | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9955 | 1.7103e-03 | 1.0892e-03 | 94.75 | 0.00 | 0.949 | 3.0619e-02 |
| eh_love_equivalence_minus_j96 | real_eh_j_scale_scan | True | 1 | 96.0 | region_shape_pass | 0.9943 | 4.4011e-03 | 1.3902e-03 | 22.04 | 0.00 | 0.914 | 2.9950e-02 |
| eh_love_equivalence_plus_j96 | real_eh_j_scale_scan | True | 1 | 96.0 | region_shape_pass | 0.9935 | 8.4455e-03 | 1.5811e-03 | 159.28 | 0.00 | 0.862 | 3.0096e-02 |
| electric_only_outgoing | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9771 | 2.1873e-02 | 5.5326e-03 | 157.06 | 0.00 | 0.767 | 1.4780e+04 |
| hfield_electric_only | real_hfield_only | True | 1 | 1.0 | region_shape_pass | 0.9770 | 2.5383e-02 | 5.5125e-03 | 33.77 | 0.00 | 0.766 | 1.4429e+04 |
...
```powershell
python code\run_cst_meshsafe_huygens_extrapolation.py --local-nearfield data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\geometric_farthest_32_poly_full96_efield.csv --sample-id L1_short_dipole_x_1p2G --out-dir data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\geometric_farthest_32\poly_reconstruct_full96
```
