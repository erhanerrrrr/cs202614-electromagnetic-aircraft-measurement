...
| Item | Path |
|---|---|
| Local Huygens E field | `data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\geometric_farthest_24_poly_full96_efield.csv` |
| Local Huygens H field | `data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\geometric_farthest_24_poly_full96_hfield.csv` |
...
| Tangential/total L2 ratio | `0.9864` |
| Normal/total L2 ratio | `0.1644` |
| Dynamic range / dB | `11.34` |
| H tangential/total L2 ratio | `0.9998` |
| H normal/total L2 ratio | `0.0198` |
| H dynamic range / dB | `18.57` |
| Tangential E/H impedance / ohm | `369.779` |
...
| Correlation | `0.9937` |
| Normalized NMSE | `2.6655e-03` |
| Scale-fitted power NMSE | `1.5381e-03` |
| Main-lobe error / deg | `86.59` |
| Region-lobe error / deg | `0.00` |
| Region-lobe Jaccard | `0.933` |
| Region-lobe min capture | `0.946` |
...
|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| outgoing_equivalence_plus | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9937 | 2.6655e-03 | 1.5381e-03 | 86.59 | 0.00 | 0.933 | 3.0635e-02 |
| eh_love_equivalence_minus | real_eh_surface_currents | True | 1 | 1.0 | region_shape_pass | 0.9937 | 2.6679e-03 | 1.5390e-03 | 86.59 | 0.00 | 0.934 | 3.0634e-02 |
| magnetic_only_plus | not_used | False | 1 |  | region_shape_pass | 0.9937 | 2.6726e-03 | 1.5403e-03 | 86.59 | 0.00 | 0.933 | 3.0635e-02 |
| magnetic_only_minus | not_used | False | 1 |  | region_shape_pass | 0.9937 | 2.6726e-03 | 1.5403e-03 | 86.59 | 0.00 | 0.933 | 3.0635e-02 |
| eh_love_equivalence_plus | real_eh_surface_currents | True | 1 | 1.0 | region_shape_pass | 0.9937 | 2.6773e-03 | 1.5417e-03 | 86.59 | 0.00 | 0.933 | 3.0635e-02 |
| outgoing_equivalence_minus | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9937 | 2.6797e-03 | 1.5426e-03 | 86.59 | 0.00 | 0.933 | 3.0635e-02 |
| eh_love_equivalence_minus_j96 | real_eh_j_scale_scan | True | 1 | 96.0 | region_shape_pass | 0.9927 | 3.2592e-03 | 1.7832e-03 | 142.26 | 0.00 | 0.932 | 2.9991e-02 |
| eh_love_equivalence_plus_j96 | real_eh_j_scale_scan | True | 1 | 96.0 | region_shape_pass | 0.9916 | 3.6969e-03 | 2.0379e-03 | 159.28 | 0.00 | 0.918 | 3.0091e-02 |
| electric_only_outgoing | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9760 | 1.6815e-02 | 5.9217e-03 | 159.18 | 0.00 | 0.802 | 1.4723e+04 |
| hfield_electric_only | real_hfield_only | True | 1 | 1.0 | region_shape_pass | 0.9708 | 2.8302e-02 | 6.9988e-03 | 33.77 | 0.00 | 0.733 | 1.4478e+04 |
...
```powershell
python code\run_cst_meshsafe_huygens_extrapolation.py --local-nearfield data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\geometric_farthest_24_poly_full96_efield.csv --sample-id L1_short_dipole_x_1p2G --out-dir data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\geometric_farthest_24\poly_reconstruct_full96
```
