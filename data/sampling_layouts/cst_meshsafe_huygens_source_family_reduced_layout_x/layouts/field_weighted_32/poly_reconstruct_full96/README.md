...
| Item | Path |
|---|---|
| Local Huygens E field | `data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\field_weighted_32_poly_full96_efield.csv` |
| Local Huygens H field | `data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\field_weighted_32_poly_full96_hfield.csv` |
...
| Normal/total L2 ratio | `0.1591` |
| Dynamic range / dB | `12.24` |
| H tangential/total L2 ratio | `0.9994` |
| H normal/total L2 ratio | `0.0338` |
| H dynamic range / dB | `17.23` |
| Tangential E/H impedance / ohm | `373.294` |
| Tangential E/H eta0 ratio | `0.9909` |
...
| Correlation | `0.9960` |
| Normalized NMSE | `1.8232e-03` |
| Scale-fitted power NMSE | `9.9062e-04` |
| Main-lobe error / deg | `104.08` |
| Region-lobe error / deg | `0.00` |
| Region-lobe Jaccard | `0.944` |
| Region-lobe min capture | `0.958` |
...
|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| eh_love_equivalence_minus | real_eh_surface_currents | True | 1 | 1.0 | region_shape_pass | 0.9960 | 1.8232e-03 | 9.9062e-04 | 104.08 | 0.00 | 0.944 | 3.0525e-02 |
| outgoing_equivalence_minus | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9960 | 1.8256e-03 | 9.9120e-04 | 104.08 | 0.00 | 0.944 | 3.0523e-02 |
| magnetic_only_plus | not_used | False | 1 |  | region_shape_pass | 0.9960 | 1.8338e-03 | 9.9128e-04 | 104.08 | 0.00 | 0.944 | 3.0524e-02 |
| magnetic_only_minus | not_used | False | 1 |  | region_shape_pass | 0.9960 | 1.8338e-03 | 9.9128e-04 | 104.08 | 0.00 | 0.944 | 3.0524e-02 |
| outgoing_equivalence_plus | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9960 | 1.8422e-03 | 9.9146e-04 | 104.08 | 0.00 | 0.944 | 3.0524e-02 |
| eh_love_equivalence_plus | real_eh_surface_currents | True | 1 | 1.0 | region_shape_pass | 0.9960 | 1.8446e-03 | 9.9204e-04 | 104.08 | 0.00 | 0.944 | 3.0523e-02 |
| eh_love_equivalence_minus_j96 | real_eh_j_scale_scan | True | 1 | 96.0 | region_shape_pass | 0.9943 | 4.6887e-03 | 1.3929e-03 | 142.26 | 0.00 | 0.915 | 3.0004e-02 |
| eh_love_equivalence_plus_j96 | real_eh_j_scale_scan | True | 1 | 96.0 | region_shape_pass | 0.9939 | 6.1275e-03 | 1.5349e-03 | 159.28 | 0.00 | 0.888 | 2.9846e-02 |
| electric_only_outgoing | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9791 | 1.3661e-02 | 5.0958e-03 | 36.13 | 0.00 | 0.844 | 1.4444e+04 |
| hfield_electric_only | real_hfield_only | True | 1 | 1.0 | shape_pass_lobe_ambiguous | 0.9742 | 3.2835e-02 | 6.3809e-03 | 33.77 | 0.00 | 0.697 | 1.4322e+04 |
...
```powershell
python code\run_cst_meshsafe_huygens_extrapolation.py --local-nearfield data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\field_weighted_32_poly_full96_efield.csv --sample-id L1_short_dipole_x_1p2G --out-dir data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\field_weighted_32\poly_reconstruct_full96
```
