...
| Item | Path |
|---|---|
| Local Huygens E field | `data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\geometric_farthest_48_poly_full96_efield.csv` |
| Local Huygens H field | `data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\geometric_farthest_48_poly_full96_hfield.csv` |
...
| Normal/total L2 ratio | `0.1582` |
| Dynamic range / dB | `12.13` |
| H tangential/total L2 ratio | `0.9996` |
| H normal/total L2 ratio | `0.0297` |
| H dynamic range / dB | `17.62` |
| Tangential E/H impedance / ohm | `369.814` |
...
| Correlation | `0.9955` |
| Normalized NMSE | `1.5725e-03` |
| Scale-fitted power NMSE | `1.0901e-03` |
| Main-lobe error / deg | `168.83` |
| Region-lobe error / deg | `0.00` |
| Region-lobe Jaccard | `0.956` |
| Region-lobe min capture | `0.969` |
...
|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| eh_love_equivalence_minus | real_eh_surface_currents | True | 1 | 1.0 | region_shape_pass | 0.9955 | 1.5725e-03 | 1.0901e-03 | 168.83 | 0.00 | 0.956 | 3.0904e-02 |
| outgoing_equivalence_plus | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9955 | 1.5963e-03 | 1.0929e-03 | 166.44 | 0.00 | 0.955 | 3.0905e-02 |
| magnetic_only_plus | not_used | False | 1 |  | region_shape_pass | 0.9955 | 1.5793e-03 | 1.0933e-03 | 166.44 | 0.00 | 0.956 | 3.0905e-02 |
| magnetic_only_minus | not_used | False | 1 |  | region_shape_pass | 0.9955 | 1.5793e-03 | 1.0933e-03 | 166.44 | 0.00 | 0.956 | 3.0905e-02 |
| outgoing_equivalence_minus | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9955 | 1.5749e-03 | 1.0937e-03 | 168.83 | 0.00 | 0.956 | 3.0904e-02 |
| eh_love_equivalence_plus | real_eh_surface_currents | True | 1 | 1.0 | region_shape_pass | 0.9955 | 1.5978e-03 | 1.0966e-03 | 166.44 | 0.00 | 0.955 | 3.0905e-02 |
| eh_love_equivalence_minus_j96 | real_eh_j_scale_scan | True | 1 | 96.0 | region_shape_pass | 0.9948 | 6.4259e-03 | 1.2489e-03 | 176.00 | 0.00 | 0.905 | 3.0249e-02 |
| eh_love_equivalence_plus_j96 | real_eh_j_scale_scan | True | 1 | 96.0 | region_shape_pass | 0.9924 | 8.3751e-03 | 1.8410e-03 | 161.67 | 0.00 | 0.869 | 3.0331e-02 |
| electric_only_outgoing | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9823 | 1.6446e-02 | 4.2565e-03 | 157.06 | 0.00 | 0.822 | 1.4750e+04 |
| hfield_electric_only | real_hfield_only | True | 1 | 1.0 | shape_pass_lobe_ambiguous | 0.9697 | 3.5135e-02 | 7.2685e-03 | 31.41 | 0.00 | 0.670 | 1.4269e+04 |
...
```powershell
python code\run_cst_meshsafe_huygens_extrapolation.py --local-nearfield data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\geometric_farthest_48_poly_full96_efield.csv --sample-id L1_short_dipole_x_1p2G --out-dir data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\geometric_farthest_48\poly_reconstruct_full96
```
