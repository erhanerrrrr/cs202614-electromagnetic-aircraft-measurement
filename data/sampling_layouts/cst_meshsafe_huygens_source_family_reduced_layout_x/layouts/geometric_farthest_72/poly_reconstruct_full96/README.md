...
| Item | Path |
|---|---|
| Local Huygens E field | `data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\geometric_farthest_72_poly_full96_efield.csv` |
| Local Huygens H field | `data\sampling_layouts\cst_meshsafe_huygens_source_family_reduced_layout_x\layouts\geometric_farthest_72_poly_full96_hfield.csv` |
...
| Normal/total L2 ratio | `0.1601` |
| Dynamic range / dB | `10.86` |
| H tangential/total L2 ratio | `0.9996` |
| H normal/total L2 ratio | `0.0268` |
| H dynamic range / dB | `16.73` |
| Tangential E/H impedance / ohm | `369.921` |
...
| Correlation | `0.9954` |
| Normalized NMSE | `2.0888e-03` |
| Scale-fitted power NMSE | `1.1060e-03` |
| Main-lobe error / deg | `154.50` |
| Region-lobe error / deg | `0.00` |
| Region-lobe Jaccard | `0.945` |
| Region-lobe min capture | `0.959` |
...
|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| eh_love_equivalence_minus | real_eh_surface_currents | True | 1 | 1.0 | region_shape_pass | 0.9954 | 2.0888e-03 | 1.1060e-03 | 154.50 | 0.00 | 0.945 | 3.1065e-02 |
| outgoing_equivalence_plus | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9954 | 2.1576e-03 | 1.1069e-03 | 154.50 | 0.00 | 0.946 | 3.1066e-02 |
| magnetic_only_plus | not_used | False | 1 |  | region_shape_pass | 0.9954 | 2.1202e-03 | 1.1085e-03 | 154.50 | 0.00 | 0.946 | 3.1065e-02 |
| magnetic_only_minus | not_used | False | 1 |  | region_shape_pass | 0.9954 | 2.1202e-03 | 1.1085e-03 | 154.50 | 0.00 | 0.946 | 3.1065e-02 |
| outgoing_equivalence_minus | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9954 | 2.0835e-03 | 1.1102e-03 | 154.50 | 0.00 | 0.945 | 3.1064e-02 |
| eh_love_equivalence_plus | real_eh_surface_currents | True | 1 | 1.0 | region_shape_pass | 0.9954 | 2.1521e-03 | 1.1111e-03 | 154.50 | 0.00 | 0.946 | 3.1064e-02 |
| eh_love_equivalence_minus_j96 | real_eh_j_scale_scan | True | 1 | 96.0 | region_shape_pass | 0.9943 | 6.5267e-03 | 1.3840e-03 | 176.00 | 0.00 | 0.905 | 3.0491e-02 |
| eh_love_equivalence_plus_j96 | real_eh_j_scale_scan | True | 1 | 96.0 | region_shape_pass | 0.9925 | 1.0611e-02 | 1.8286e-03 | 159.28 | 0.00 | 0.843 | 3.0407e-02 |
| electric_only_outgoing | fixed_eta0 | False | 1 |  | region_shape_pass | 0.9804 | 1.6136e-02 | 4.7266e-03 | 36.13 | 0.00 | 0.819 | 1.4631e+04 |
| hfield_electric_only | real_hfield_only | True | 1 | 1.0 | diagnostic_only | 0.9517 | 4.1215e-02 | 1.1592e-02 | 36.13 | 0.00 | 0.380 | 1.4363e+04 |
