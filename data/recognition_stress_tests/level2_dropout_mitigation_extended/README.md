...
- Held-out families tested: combined, dropout.
- Strategies tested: zero_fill, mask_features, freq_sensor_median_impute, freq_sensor_median_impute_mask.
- Stress cases tested: dropout_10pct, dropout_25pct, noise10_phase15_dropout10.
- Total rows: 180.
- All rows pass accuracy >= 0.85: `true`.
- Worst single row: seed `202614`, `full_grid_162` / `mask_features` / `dropout_25pct` with accuracy `0.867`.
- Best average strategy: `freq_sensor_median_impute` with mean accuracy `1.000`, min accuracy `1.000`, and mean delta vs zero-fill `+0.009`.
- Tightest aggregate row: `full_grid_162` / `mask_features` / `dropout_25pct`, mean `0.956`, min `0.867`, mean delta vs zero-fill `-0.044`.

## Strategy Summary

| Strategy | Seeds | Rows | Mean accuracy | Min accuracy | 95% CI low | 95% CI high | Mean delta vs zero-fill | Passes 0.85 |
|---|---:|---:|---:|---:|---:|---:|---:|---|
| zero_fill | 3 | 45 | 0.991 | 0.867 | 0.983 | 0.999 | +0.000 | true |
| mask_features | 3 | 45 | 0.993 | 0.867 | 0.985 | 1.000 | +0.001 | true |
| freq_sensor_median_impute | 3 | 45 | 1.000 | 1.000 | 1.000 | 1.000 | +0.009 | true |
| freq_sensor_median_impute_mask | 3 | 45 | 1.000 | 1.000 | 1.000 | 1.000 | +0.009 | true |

## Tightest Case Rows

| Candidate | Stress case | Strategy | Mean accuracy | Min accuracy | Mean delta vs zero-fill | Passes 0.85 |
|---|---|---|---:|---:|---:|---|
| full_grid_162 | dropout_25pct | mask_features | 0.956 | 0.867 | -0.044 | true |
| task_driven_48 | dropout_25pct | zero_fill | 0.956 | 0.867 | +0.000 | true |
| geometric_farthest_32 | dropout_25pct | zero_fill | 0.956 | 0.933 | +0.000 | true |
| geometric_farthest_32 | dropout_25pct | mask_features | 0.978 | 0.933 | +0.022 | true |
| fibonacci_snap_120 | dropout_25pct | mask_features | 0.978 | 0.933 | -0.022 | true |
| task_driven_32 | dropout_10pct | zero_fill | 0.978 | 0.933 | +0.000 | true |
| task_driven_32 | dropout_25pct | zero_fill | 0.978 | 0.933 | +0.000 | true |
| task_driven_32 | dropout_25pct | mask_features | 0.978 | 0.933 | +0.000 | true |
| full_grid_162 | dropout_10pct | zero_fill | 1.000 | 1.000 | +0.000 | true |
| full_grid_162 | dropout_25pct | zero_fill | 1.000 | 1.000 | +0.000 | true |
| full_grid_162 | dropout_10pct | mask_features | 1.000 | 1.000 | +0.000 | true |
| full_grid_162 | dropout_10pct | freq_sensor_median_impute | 1.000 | 1.000 | +0.000 | true |
...
```powershell
python code\run_cst_recognition_dropout_mitigation.py --layout-candidates full_grid_162,geometric_farthest_32,fibonacci_snap_120,task_driven_32,task_driven_48 --held-out-families dropout,combined --strategies zero_fill,mask_features,freq_sensor_median_impute,freq_sensor_median_impute_mask --seeds 202614,202615,202616 --out-dir data\recognition_stress_tests\level2_dropout_mitigation_extended
```
